...
namespace shapes
{
    ...
    class Rectangle
    {
        ...
        public Rectangle() { }//tabe mokhareb
    ...
    class Trapezoid
    {
        ...
        public Trapezoid() { }//tabe mokhareb
    ...
    class Ellipse
    {
        private double a;//shoae aval
        private double b;//shoae dovom 
        double pi = 3.14;
        public double A
        {
            get { return a; }
    ...
    class Polygon
    {
        private double a;//tole zele
        private double n;//tedade azlae
        private double h;//height
        public double A
        {
            get { return a; }
